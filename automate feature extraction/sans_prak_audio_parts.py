...
audio_segment = AudioSegment.from_wav('Sanskruti//audio.wav')
normalized_sound = match_target_amplitude(audio_segment, -20.0)

print("length of audio_segment={} seconds".format(len(normalized_sound)/1000))

nonsilent_data = detect_nonsilent(normalized_sound, min_silence_len=4000, silence_thresh=-25, seek_step=1)
...
for i, chunks in enumerate(nonsilent_data):
	...
	audio_chunk1.export( "Sanskruti"+"//Audio Record//"+"answer_chunk{}.wav".format(i), format="wav")
	# if flg==1:
		# prev = chunks[0]
...
df.to_csv("Sanskruti//timestamps3.csv",header= False)
# print(list1)
